...
const explicaciones = [
  ...
  "Aplicaremos el algoritmo de Strassen a esta matriz de 4x4.",
  "La dividiremos en 4 matrices de 2x2.",
  "Ahora seleccionamos nuestra segunda matriz.",
  "También aplicaremos el algoritmo de Strassen de manera recursiva.",
  ...
  "Si te fijas, realmente sólo estamos realizando 7 pasos recursivos en vez de 8.",
...
jQuery(function ($) {
  ...
  $("#siguiente").on("click", function (e) {
    let ae = $("#a11").val() * $("#b11").val();
    let bg = $("#a12").val() * $("#b21").val();
    let af = $("#a11").val() * $("#b12").val();
    let bh = $("#a12").val() * $("#b22").val();
    let ce = $("#a21").val() * $("#b11").val();
    let dg = $("#a22").val() * $("#b21").val();
    let cf = $("#a21").val() * $("#b12").val();
    let dh = $("#a22").val() * $("#b22").val();
