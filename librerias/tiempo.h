...
// Definición de estructura para encapsular los datos.
typedef struct medicion_tiempo_t
{
  double usertime;
  double systime;
  double walltime;
...
// Definición de estructura para encapsular los resultados de medición.
typedef struct resultados_tiempo_t
{
  double real;
  double user;
  double sys;
...
// Prototipo de función para medir tiempos usando la estructura anterior.
void guardar_tiempo(medicion_tiempo *);

// Prototipo de función para calcular los resultados de dos mediciones.
resultados_tiempo calcular_resultados(medicion_tiempo, medicion_tiempo);
